...
-- Create a default user for single-user mode (if no auth)
-- You can delete this if you implement proper authentication
INSERT INTO users (id, email) VALUES 
  ('00000000-0000-0000-0000-000000000000', 'default@user.com')
ON CONFLICT (id) DO NOTHING;

-- Create default coin balance for default user
